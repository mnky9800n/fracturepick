            ...
            while ni<=numnois:
                ...
                while mi<=11:
                    ...
                    if mi==1:
                        ...
                        thr = filters.threshold_li(image)
                    elif mi==4:
                        thr = filters.threshold_mean(image)
                    elif mi==5:
                        thr = filters.threshold_niblack(image)
                    elif mi==6:
                        thr = filters.threshold_otsu(image)
                    elif mi==7:
                        thr = filters.threshold_sauvola(image)
                    elif mi==8:
                        thr = filters.threshold_triangle(image)
                    elif mi==9:
                        thr= filters.threshold_local(image, 17, 'gaussian')
                    elif mi==10:
                        thr = filters.threshold_local(image, 17, 'mean')            
                    elif mi==11:
                        thr = filters.threshold_local(image, 17, 'median')                
                    elif mi==12:
                        thr= filters.threshold_local(image, 21, 'gaussian')
                    elif mi==13:
                        thr = filters.threshold_local(image, 21, 'mean')            
                    elif mi==14:
                        thr = filters.threshold_local(image, 21, 'median')      
                    elif mi==15:
                        thr= filters.threshold_local(image, 25, 'gaussian')
                    elif mi==16:
                        thr = filters.threshold_local(image, 25, 'mean')            
                    elif mi==17:
                        thr = filters.threshold_local(image, 25, 'median')  
